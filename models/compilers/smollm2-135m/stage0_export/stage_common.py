"""Shared utilities for SmolLM2 stage0 export."""
...
def patch_dynamic_cache_for_export() -> None:
    from transformers.cache_utils import DynamicLayer

    if getattr(DynamicLayer, "_stage0_export_patched", False):
        return
    ...
    DynamicLayer._stage0_export_patched = True
...
def create_prefill_example_inputs(tokenizer, seq_len: int):
    prompt = "The quick brown fox jumps over"
    return tokenizer(prompt, return_tensors="pt", padding="max_length", max_length=seq_len)
